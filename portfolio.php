                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html"><i class="icon_house_alt"></i> Acceuil</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Portfeuille</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row akame-portfolio-area">
                ...
                <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item barber mb-30 wow fadeInUp" data-wow-delay="800ms">
                    <div class="akame-portfolio-single-item">
                        <img src="img/bg-img/102.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="img/bg-img/102.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item hairstyle mb-30 wow fadeInUp" data-wow-delay="800ms">
                    <div class="akame-portfolio-single-item">
                        <img src="img/bg-img/cuisine.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="img/bg-img/cuisine.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item hairstyle mb-30 wow fadeInUp" data-wow-delay="200ms">
                    <div class="akame-portfolio-single-item">
                        <img src="img/bg-img/cuisine1.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="img/bg-img/cuisine1.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item massage mb-30 wow fadeInUp" data-wow-delay="500ms">
                    <div class="akame-portfolio-single-item">
                        <img src="img/bg-img/302.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="img/bg-img/302.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 akame-portfolio-item massage mb-30 wow fadeInUp" data-wow-delay="800ms">
                    <div class="akame-portfolio-single-item">
                        <img src="img/bg-img/303.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="img/bg-img/303.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
            </div>
    ...
    <section class="breadcrumb-area section-padding-80">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        ...
                        <h5>Catalogues Design cuisine</h5><br/>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html"><i class="icon_house_alt"></i> Acceuil</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Portfeuille</li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-content">
        <a href="https://onlinecatalogue.ikea.com/FR/fr/In-Store_Range_Brochure_Kitchen_Metod/?_ga=2.199928104.780124870.1550357798-1140086647.1550357798#/pages/1" download="Pacman_Kiwi"><img class="catalogue" src="img/bg-img/305.jpg" alt=""></a>
         <a href="https://www.cuisine-schmidt.ch/wp-content/uploads/ftp/catalogue-salle-de-bains.pdf" download="Pacman_Kiwi"><img class="catalogue" src="img/bg-img/306.jpg" alt=""></a>
         <a href="https://onlinecatalogue.ikea.com/CH/fr/In-Store_Range_Brochure_Wardrobe/#/" download="Pacman_Kiwi"><img class="catalogue" src="img/bg-img/307.jpg" alt=""></a>
         <a target="_blank" >
     </div>
 </div>
</div>
