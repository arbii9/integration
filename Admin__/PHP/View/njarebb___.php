        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li> <!-- class="active treeview"  -->
              <a href="#">
                <i class="fa fa-book"></i> <span>Produit</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
            ...
            <li>
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Employe</span> <small class="label pull-right bg-green"></small><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Table Employe</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Table Type</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-share"></i> <span>SAV</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Table et Statistique</a></li>
              </ul>
            </li>
            <li>
