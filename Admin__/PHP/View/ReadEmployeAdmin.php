        ...
        <section class="sidebar">
         ...
         <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Table Employe</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Read Employe</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    <form method="POST">
                      ...
                      outline: none;">
                      <input type="submit" name="Search" value="Search" style="background: #167F92; padding: 8px 15px 8px 15px;border: none;color: #fff;"><span> </span>
                ...
                <a href="PdfEmploye.php" target="_blank" style="color: #167F92;">cliquez ici pour obtenir tout en pdf</a> <span style="color: #167F92; ">______________________________________________________________________________________________________________ </span><a href="formEmp_.html" style="color: #167F92;">ajouter employe</a>
                    </table>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
