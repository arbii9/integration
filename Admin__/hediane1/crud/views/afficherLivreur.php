...
if(isset($_POST['search']))
{
    ...
    $sql = "SELECT * FROM `livreur` WHERE id_livreur LIKE '".$valueToSearch."%' order by nom"; 
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
               <li><a href="../../pages/forms/advanced.php"><i class="fa fa-circle-o"></i> Livraisons</a></li>
                <li class="active"><a href="../../pages/forms/editors.php"><i class="fa fa-circle-o"></i> Livreurs</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
...
<!--<div class="button" style="position: absolute; left:250px; top:100px;"> 
...
foreach($listeLivreur as $row)
{
 ?>
  ...
  <td><form method="POST" action="../../crud/views/supprimerLivreur.php">
  <input type="submit" name="supprimer" value="supprimer">
  <input type="hidden" value="<?PHP echo $row['id_livreur']; ?>" name="id_livreur">
  </form>
  </td>
  <td><a href="../../crud/views/modifierLivreur.php?id_livreur=<?PHP  echo $row['id_livreur']; ?>">
  Modifier</a></td>
  </tr>
<?PHP
}
