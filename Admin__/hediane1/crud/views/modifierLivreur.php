  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <!-- Main content -->
         <?php
         include "../../crud/entities/livreur.php";
...
<input type="number" name="tel_livreur" value="<?PHP echo $tel_livreur ?>">
</li>
<li>
<label></label>
...
<li>
<label></label>
<input type="hidden" name="id_livreur" value="<?PHP echo $_GET['id_livreur'];?>">
</li>
</ul>
</form>
<?PHP
...
?>
    ...
    <script src="../../dist/js/livreur.js"></script>
