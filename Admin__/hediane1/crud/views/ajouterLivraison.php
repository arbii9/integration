...
<html>
  ...
  <body class="skin-blue">
    ...
    <!-- AdminLTE for demo purposes -->
         <p style="position: fixed;left: 500px;font-size: 20px;top:200px">L'ajout de la livraison se fait avec succés <br> si vous voulez allez vers l'affichage des livraisons pour modifier ,supprimer clique <a href="../../crud/views/afficherLivraison.php">ici</a> <br> si vous voulez ajouter une autre livraison cliquez <a href="../../pages/forms/advanced.php" >ici</a></p>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
    </div><!-- ./wrapper -->

    <script src="../../dist/js/livraison.js"></script>
