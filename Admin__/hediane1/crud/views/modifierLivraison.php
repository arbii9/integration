...
<html>
  <head>
    ...
    <![endif]-->
    <script src="../../dist/js/livraison_.js"></script>
  </head>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
               <li class="active"><a href="../../pages/forms/advanced.php"><i class="fa fa-circle-o"></i> Livraisons</a></li>
                <li><a href="../../pages/forms/editors.php"><i class="fa fa-circle-o"></i> Livreurs</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
...
<?php
include "../../crud/entities/livraison.php";
include "../../crud/core/livraisonC.php";
...
?>
<form method="POST" id="form_modifier">
...
<input type="text" id="Commande" name="id_commande"  value="<?PHP echo $id_commande ?>" onblur="Controle(this.id)">
</li> 
<li>
<label>id_livreur</label>
<input type="text" id="Livreur" name="id_livreur"  value="<?PHP echo $id_livreur ?>" onblur="Controle(this.id)">
</li>
<li>
<label>Adresse</label>
<input type="text" id="Adresse" name="adresse" value="<?PHP echo $adresse ?>" onblur="Controle(this.id)">
</li>
<li>
<label>Telephone</label>
<input type="text" id="Numero" name="num_tel"  value="<?PHP echo $num_tel ?>" onblur="Controle(this.id)" onfocus="javascript:if(this.value == '') { this.value = '+216 '; } " onfocusout="javascript:if(this.value == '+216 ') { this.value = ''; }">
</li>
<li>
<label>Date</label>
<input type="date" id="Date" name="date"  id="Date"value="<?PHP echo $date ?>" onblur="Controle(this.id)">
</li>
<li>

<input type="button" name="modifier" value="modifier" onclick="verifier()">
</li>
<li>

<input type="hidden" name="id_livraison" value="<?PHP echo $_GET['id_livraison'];?>">
</li>
</ul>
</form>
<?PHP
...
if (isset($_POST['id_commande'])){
  ...
  header('Location: ../../crud/views/afficherLivraison.php');
}
?>
