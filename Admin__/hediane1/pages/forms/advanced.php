...
<html>
  ...
  <body class="skin-blue">
    <div class="wrapper">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
               <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Livraisons</a></li>
                <li><a href="editors.php"><i class="fa fa-circle-o"></i> Livreurs</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
     ...
     <div id="champs1" class="champs1" style="top: 220px;position:absolute;"></div>
     <div id="champs2" class="champs2" style="top: 270px;position:absolute;"></div>
    <div id="champs3" class="champs3" style="top: 340px;position:absolute;"></div>
    <div id="champs5" class="champs5" style="top: 480px;position:absolute;"></div>
