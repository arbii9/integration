...
?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <h2>Qui somme_nous ?</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html"><i class="icon_house_alt"></i><span class="mx-2"></span>Acceuil</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Contactez_nous</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="akame-our-expert-area about-us-page section-padding-80-0">
        ...
        <!-- Side Thumbnail -->
        <div class="side-thumbnail" style="background-image: url(img/bg-img/102.jpg);"></div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="section-heading text-right mb-80 pr-5 pt-3">
                        <!--<p>Bizerte • Depuis 2004</p>
                        <h2>À propos de nos histoires</h2>-->
                        <span>History</span>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="about--us--content mb-80">
                        ...
                        <img  class="signiature1" src="img/core-img/signiature1.png" alt="" >
                        <h4>Design cuisine</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-10">
                    <div class="testimonial-slides owl-carousel">
                        ...
                        <div class="single-testimonial-slide">
                            ...
                            <p>"Design cuisine" Leader sur le marché tunisien ne cesse d'évolué et de s'étendre à l'échelle nationale et international.</p>
                        ...
                        <div class="single-testimonial-slide">
                            <img src="img/core-img/quote.png" alt="">
                            <p>Nous s'engage à répondre aux besoins de ces clients et fournir tous les moyens nécessaires pour leurs atteintes.</p>
                            <div class="ratings-name d-flex align-items-center justify-content-center">
                                <div class="ratings mr-3">
                                    <i class="icon_star"></i>
                                    <i class="icon_star"></i>
                        ...
                        <div class="single-testimonial-slide">
                            <img src="img/core-img/quote.png" alt="">
                            <p>Nous responsabilisons et formons nos collaborateurs à refuser tout compromis en matière de qualité.</p>
                            <div class="ratings-name d-flex align-items-center justify-content-center">
                                <div class="ratings mr-3">
                                    <i class="icon_star"></i>
                                    <i class="icon_star"></i>
                ...
                <div class="col-12">
                    <div class="video-content-area mb-80">
                       <!-- <img src="img/bg-img/cuisine.jpg" alt="">
                        <a href="https://www.youtube.com/watch?v=jLGQiX6wIcg" class="video-play-btn wow bounceInDown" data-wow-delay="200ms"><i class="fa fa-play"></i></a>-->
                        <video src= "video.mp4" controls="" poster="img/bg-img/cuisine1.jpg" width="1075"> </video>
                    </div>
                </div>
            </div>
