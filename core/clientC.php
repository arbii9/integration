...
class clientC {
	...
	function afficherclientcin($cin)
	{
...
// 	function modifi($client,$cin)
// 	{

// 		$sql="UPDATE client SET mdp=:mdpp WHERE cin=:cin";
...
//       $mdpp=$client->getmdp();
// 		$datas = array( ':cin'=>$cin, ':mdp'=>$mdpp, ':mdp'=>$mdp);
	
// 		$req->bindValue(':cin',$cin);
// 		$req->bindValue(':mdp',$mdpp);
// 		$req->bindValue(':mdp',$mdp);
...
// 	}
	...
	function mod($mdp,$cin){
		$sql="UPDATE client SET mdp='$mdp'  WHERE cin=$cin";
...
function recherche_email($cin)
{
	$db=config::getConnexion();
        $sql="select email from client where cin  like '%$rech%'";
