...
<input type="text" name="nom" id="nom" placeholder="Your Name *" style="width: 200px" required="required" minlength="3"><input style="margin-left: 250px; margin-top: -160px ; width: 200px" type="text" name="prenom" id="prenom" placeholder="Ton Prenom *" required="required">
...
<input type="password" name="mdp" id="mdp" placeholder="Ton mot de passe" style="width: 200px" required="required" minlength="3"><input style="margin-left: 250px ; width: 200px "type="password" name="mdp" id="mdp2" placeholder="confirmer votre mot de passe">
