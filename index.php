...
<!-- annimation des images-->
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms" class="aaaaa">bienvenue <br> </h2>
                                    <p data-animation="fadeInUp" data-delay="400ms">“Decouvrir nos produits .”</p>
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img" style="background-image: url(img/bg-img/cuisine.jpg);">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">Meuble sur mesure en<br/> ligne: choix, qualité, prix</h2>
                                    <p data-animation="fadeInUp" data-delay="400ms" class="description1">“Créez votre meuble en quelque clics, nous vous le livrons chez vous en kit.Livraison gratuite partout en tunisie.”</p>
                                    <a href="./about.html" class="btn akame-btn active" data-animation="fadeInUp" data-delay="700ms">About Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <h5>Dressing</h5>
                        <p>Laissez libre cours à votre imagination :l’expert design, c’est vous!</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="400ms">
                        ...
                        <h5>Cuisine</h5>
                        <p> Moderne ou classique, nous pouvons réaliser la cuisine que vous souhaitez. </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="600ms">
                        ...
                        <h5>Porte</h5>
                        <p>un large choix de portes équipées sur mesure. <br> <br></p>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="800ms">
                        ...
                        <h5>Salle de bain</h5>
                        <p>un grand choix de finitions et autres options qui vous faciliteront la vie.</p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading">
                        ...
                        <p>Une offre unique de meubles contemporains de qualité, à un prix abordable et disponible rapidement.</p>
                    </div>
                    <!-- Choose Us Content -->
                    <div class="choose-us-content mt-30 mb-80">
                        <ul>
                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i>  Une solution de personnalisation de ses finitions, coloris, matières.</li>
                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> la possibilité de participer soi-même à la fabrication de son meuble.</li>
                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Des matériaux de qualité au prix juste.</li>
                            <li><i class="fa fa-check-square-o" aria-hidden="true"></i> Votre mobilier de rêve sera réel et unique </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="portfolio-menu text-center mb-30">
                        <button class="btn active" data-filter="*">Tous nos produits</button>
                        <button class="btn" data-filter=".haircuts">Salle de bain</button>
                        <button class="btn" data-filter=".dye">Cuisine</button>
                        <button class="btn" data-filter=".shave">Dressing</button>
                        <button class="btn" data-filter=".hairstyle">Porte</button>
                    </div>
                </div>
            </div>
            ...
            <div class="row akame-portfolio-area">
                ...
                <div class="col-12 col-sm-6 col-lg-3 akame-portfolio-item haircuts mb-30 wow fadeInUp" data-wow-delay="200ms">
                    <div class="akame-portfolio-single-item">
                        <img src="img/bg-img/301.jpg" alt="">
                 <!-- Overlay Content -->
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="img/bg-img/301.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 akame-portfolio-item dye mb-30 wow fadeInUp" data-wow-delay="600ms">
                    <div class="akame-portfolio-single-item">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="img/bg-img/300.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="view-all-btn mt-30 text-center">
                        <a href="portfolio.html" class="btn akame-btn">Voir tous nos travaux</a>
                    </div>
                </div>
            </div>
        </div>
